...
<body>
    <div class="container-scroller">
        ...
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center" style="background:rgb(131, 131, 155)">
                <a class="navbar-brand brand-logo" href="/admin"><img
                        src="{{ asset('adminassets/assets/images/111.svg') }}" alt="logo" /></a>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar" style="background: rgb(201, 201, 222)">
                <ul class="nav">
                    <li class="nav-item nav-profile">
                        <a href="#" class="nav-link">
                            <div class="nav-profile-image">
                                <img src="{{ asset('adminassets/assets/images/faces/face3.jpg') }}" alt="profile">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.product') }}">
                            ...
                            <i class="mdi mdi mdi-atom menu-icon"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.transaksi') }}">
                            ...
                            <i class="mdi mdi mdi-arrow-right-box menu-icon"></i>
                        </a>
                    </li>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('laporan.penjualan') }}">
                            ...
                            <i class="mdi mdi mdi-checkerboard menu-icon"></i>
                        </a>
                    </li>
                    <li class="nav-item">
            ...
            <!-- partial -->
            <div class="main-panel" style="background:blue">
                @yield('content')
